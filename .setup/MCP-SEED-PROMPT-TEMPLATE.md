Using the [MCP-PROJECT-TEMPLATE](./MCP-PROJECT-TEMPLATE.md), and referencing [the seed prompt examples](./MCP-SEED-PROMPT-EXAMPLES.md) plan an MCP server implementation for **[DOMAIN]**.
